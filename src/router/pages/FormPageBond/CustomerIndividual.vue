        ...
        <vs-dialog width="550px" not-center v-model="checkAccept">
            ...
            <template #footer class="con-footer d-flex justify-content-end">
                <b-row class="justify-content-center">
                    <b-col>
                        <vs-button block @click="onSaveToDB" class="mr-2 mx-2">
                            ຢືນຢັນ
                        </vs-button>
                    </b-col>
                    <b-col>
            ...
            <b-col>
                ...
                <b-row class="pb-2 pt-1">
                    <b-col class="pb-2" sm="12" lg="6" md="6">
                        <label for="firstname"> ຊື່ ແລະ ນາມສະກຸນ:</label>
                        <b-form-input
                           type="text"
                           name="CUSTOMERNAME"
                ...
                <b-row class="pb-2">
                    ...
                    <!--                        <label for="firstname"> ເລກທີ {{ IDENTIFICATIONNUMBER === 'IC' ? 'ບັດປະຈຳຕົວ' : 'ໜັງສືຜ່ານແດນ' }}:-->
                    <!--                        </label>-->
                    <!--                        <b-form-input-->
                    <!--                           type="text"-->
...
export default {
    ...
    mounted() {
        ...
        this.$store.set("user_bond_data", null)
